...
export const metadata: Metadata = {
  ...
  description: "Discuss your SaaS, AI, automation, booking platform, API, dashboard, or custom web development project with Bilal Ahmed.",
  ...
  return (
    <main id="main-content">
      <StructuredData data={{
        ...
        mainEntity: { "@type": "Person", name: "Bilal Ahmed", jobTitle: "Full-Stack Developer & SaaS Builder" },
      }} />
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_1.35fr] lg:px-8">
        <aside className="rounded-2xl border bg-card p-7 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            For freelance opportunities, SaaS builds, AI integrations, automation, or technical product work.
          </p>

          <div className="mt-7 space-y-3">
            <a className="flex items-center justify-between rounded-xl border p-4 text-sm font-semibold hover:bg-muted" href={`mailto:${site.email}`}>
              Email <ExternalLink className="size-4" />
            </a>
            <a className="flex items-center justify-between rounded-xl border p-4 text-sm font-semibold hover:bg-muted" href={site.upworkUrl} target="_blank" rel="noreferrer">
              Upwork <ExternalLink className="size-4" />
            </a>
            <a className="flex items-center justify-between rounded-xl border p-4 text-sm font-semibold hover:bg-muted" href={site.githubUrl} target="_blank" rel="noreferrer">
              GitHub <ExternalLink className="size-4" />
            </a>
            <a className="flex items-center justify-between rounded-xl border p-4 text-sm font-semibold hover:bg-muted" href={site.linkedinUrl} target="_blank" rel="noreferrer">
