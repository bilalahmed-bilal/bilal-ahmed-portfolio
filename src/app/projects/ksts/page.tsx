...
export function generateMetadata(): Metadata {
  return {
    ...
    description:
      "KSTS is a multi-company bus booking and operations platform built around shared inventory, multi-office workflows, trips, passengers, and role-based access.",
    alternates: { canonical: "/projects/ksts" },
    openGraph: {
      images: ["/projects/ksts/opengraph-image"],
      title: "KSTS Case Study | Multi-company Bus Booking Platform",
      description:
        "KSTS is a multi-company bus booking and operations platform built around shared inventory, multi-office workflows, trips, passengers, and role-based access.",
      url: "/projects/ksts",
