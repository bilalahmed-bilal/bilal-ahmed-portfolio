...
export const metadata: Metadata = {
  ...
  description: "Explore Bilal Ahmed’s selected SaaS, AI, booking, automation, and business-system projects and technical case studies.",
  ...
  return (
    <main id="main-content">
      <StructuredData data={{
        ...
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "KSTS", url: `${process.env.NEXT_PUBLIC_SITE_URL ?? "http://localhost:3000"}/projects/ksts` },
          { "@type": "ListItem", position: 2, name: "AutoSEO", url: `${process.env.NEXT_PUBLIC_SITE_URL ?? "http://localhost:3000"}/projects/autoseo` },
          { "@type": "ListItem", position: 3, name: "UAIOS", url: `${process.env.NEXT_PUBLIC_SITE_URL ?? "http://localhost:3000"}/projects/uaios` },
        ],
      }} />
