      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
        <div className="max-w-4xl">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/contact"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-primary px-6 font-semibold text-primary-foreground shadow-lg shadow-primary/20 transition hover:-translate-y-0.5"
            >
            ...
            <Link
              href="/projects"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border bg-background px-6 font-semibold transition hover:bg-muted"
            >
              View My Work
            </Link>
          </div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <SectionTitle
        ...
        title="Products built around real business problems."
        text="From a booking operation to an AI-enabled SaaS workflow, I focus on useful systems rather than technology for its own sake."
      />
    ...
    <section className="border-y bg-muted/30">
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="A portfolio backed by real product work."
          text="Three products demonstrate different sides of my engineering approach: marketplace operations, AI automation, and business-system architecture."
        />
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
              AI should improve the workflow, not complicate it.
            </h2>

            <p className="mt-5 max-w-2xl leading-7 text-muted-foreground">
              I use AI where it creates practical value: content operations, analysis,
              recommendations, workflow assistance, search, and business automation.
            </p>
          </div>
    ...
    <section className="border-y bg-muted/30">
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="Structured delivery from idea to production."
          text="A clear process reduces surprises and keeps technical decisions aligned with the business goal."
        />
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <SectionTitle
        ...
        text="I care about the complete product: usability, architecture, data, integrations, maintainability, and the next stage of growth."
      />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div key={item} className="rounded-2xl border p-6 text-center font-semibold">
            {item}
          </div>
        ))}
      </div>
    ...
    <section className="border-t">
      <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-muted-foreground">
          Tell me what you are building, what is not working, or what you want to automate.
        </p>

        <Link
          href="/contact"
          className="mt-8 inline-flex h-12 items-center gap-2 rounded-xl bg-primary px-6 font-semibold text-primary-foreground"
        >
